...
python3 -u -m verl.trainer.main_ppo \
    ...
    global_profiler.save_path=$VERL_PATH/run_cmd/outputs/mem_dpsk-v2-lite_memUtil$gpu_memory_utilization \
    ...
    2>&1 | tee ../../logs/mem_analysis/mem_dsv2-lite_ppo_ep8_memUtil$gpu_memory_utilization.log
